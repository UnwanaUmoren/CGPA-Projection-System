...
function A_send(){
	reg = $(".frm .main_frm form table .trr td #reg");
	pass = $(".frm .main_frm form table .trr td #pass");
	var err_con = $(".frm .main_frm form table tr #err_con");
	loader = $(".a_load");
	var e3 = "";
	reg_val = reg.val();
	pass_val = pass.val();
			...
			success	: function(data)
					 {
						 ...
						 if (data != 3){
							 ...
							 loader.hide();
							 location.assign("http://www.projectionsystem.com/home");	 
						 }
...
function log_validate(){
	...
	reg = $(".frm .main_frm form table .trr td #reg");
	pass = $(".frm .main_frm form table .trr td #pass");
	button = $(".frm .main_frm form table tr td #log");
	var err_con = $(".frm .main_frm form table tr #err_con");
	loader = $(".a_load");
